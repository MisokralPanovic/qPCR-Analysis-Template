...
model_lmscb2_2 <- lm(log10(Copy_number)~Ct, data = scb2_2)
plot(model_lmscb2_2)
...
model.predict_scb2_2 <- 10^predict(model_lmscb2_2, 
                                   interval = 'prediction')
data.combined.predict_scb2_2 <- cbind(scb2_2, 
...
plot_scb2_2 <- ggplot(data = data.combined.predict_scb2_2,
