...
4. Values are normalised to the control log2 values, to make the rest of the changes relative to the control values.
```{math}
...
with a title that is based on the target gene that were specified in params
