...
```{r set_project_root, include=FALSE}
# Set the working directory to the project root for consistent relative paths
#setwd("../..")
knitr::opts_knit$set(root.dir = setwd("../.."))  # Ensure all chunks use the project root as base
```
